...
This project investigates whether a social media post can be classified as likely to go viral **using only information available before publication** platform, content type, topic, language, region, hashtags, sentiment, and posting time and with no post-publication engagement data (views, likes, comments, shares) used as input.
